...
async def list_airports(active_only: bool = True):
    ...
    cursor = stamps_collection.find(query, {"_id": 0, "stamp_id": 1, "name_ar": 1, "name_en": 1}).sort("sort_order", 1)
...
async def update_stamp(
    ...
    update_data = {k: v for k, v in stamp.dict().items() if v is not None}
...
async def init_default_stamps():
    ...
    default_stamps = [
        # Airports
        {"name_ar": "مطار بغداد الدولي", "name_en": "Baghdad International Airport", "stamp_type": "airport", "sort_order": 1},
        {"name_ar": "مطار البصرة الدولي", "name_en": "Basra International Airport", "stamp_type": "airport", "sort_order": 2},
        {"name_ar": "مطار أربيل الدولي", "name_en": "Erbil International Airport", "stamp_type": "airport", "sort_order": 3},
        {"name_ar": "مطار السليمانية الدولي", "name_en": "Sulaymaniyah International Airport", "stamp_type": "airport", "sort_order": 4},
        {"name_ar": "مطار النجف الدولي", "name_en": "Najaf International Airport", "stamp_type": "airport", "sort_order": 5},
        # Border crossings
        {"name_ar": "منفذ طريبيل", "name_en": "Trebil Border", "stamp_type": "border", "sort_order": 1},
        {"name_ar": "منفذ عرعر", "name_en": "Arar Border", "stamp_type": "border", "sort_order": 2},
        {"name_ar": "منفذ سفوان", "name_en": "Safwan Border", "stamp_type": "border", "sort_order": 3},
        {"name_ar": "منفذ إبراهيم الخليل", "name_en": "Ibrahim Khalil Border", "stamp_type": "border", "sort_order": 4},
        {"name_ar": "منفذ الشلامجة", "name_en": "Shalamcheh Border", "stamp_type": "border", "sort_order": 5},
        # Company stamps
        {"name_ar": "ختم الشركة الرسمي", "name_en": "Official Company Stamp", "stamp_type": "company", "sort_order": 1},
        # Signatures
        {"name_ar": "توقيع المدير العام", "name_en": "General Manager Signature", "stamp_type": "signature", "sort_order": 1},
    ]
