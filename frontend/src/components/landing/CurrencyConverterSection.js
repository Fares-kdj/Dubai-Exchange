    ...
    return (
      <div className="relative">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className={`w-full px-4 py-4 rounded-2xl border-2 flex items-center justify-between gap-3 transition-all ${
            isDark 
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              transition={{ duration: 0.2 }}
              className={`absolute z-50 w-full mt-2 rounded-2xl border-2 shadow-2xl overflow-hidden max-h-64 overflow-y-auto ${
                isDark 
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.div 
            ...
            className={`inline-flex items-center gap-2 px-5 py-2.5 mb-6 rounded-full border ${
              isDark 
        ...
        >
          <div className={`relative backdrop-blur-xl rounded-[2rem] p-8 md:p-10 overflow-hidden ${
            isDark 
            ...
            {/* Card Inner Glow */}
            <div className={`absolute top-0 left-1/2 -translate-x-1/2 w-1/2 h-1 rounded-full ${
              isDark ? 'bg-gradient-to-r from-transparent via-[#D4AF37]/50 to-transparent' : 'bg-gradient-to-r from-transparent via-[#D4AF37]/30 to-transparent'
            }`} />
            ...
            <div className="space-y-8">
                ...
                <div className="relative">
                  ...
                  >
                    <input
                      ...
                      className={`w-full px-6 py-5 text-2xl font-bold transition-all outline-none ${
                        isDark 
                    ...
                    <div className={`absolute right-6 top-1/2 -translate-y-1/2 flex items-center gap-2 ${
                      ...
                      <span className="text-lg font-semibold">{fromCurrency}</span>
                    </div>
                  </motion.div>
                  {/* Border Glow Effect */}
                  <motion.div
              ...
              <div className="grid grid-cols-1 md:grid-cols-[1fr,auto,1fr] gap-6 items-end">
                ...
                <motion.button
                  ...
                  className={`w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-2 md:mb-0 ${
                    isDark 
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <span className={`text-2xl ${isDark ? 'text-slate-400' : 'text-slate-500'}`}> {toCurrency}</span>
                          </motion.div>
